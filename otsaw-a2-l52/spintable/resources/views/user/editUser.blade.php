                ...
                <div class="ibox-content">
                    ...
                    <form  class="form-horizontal" role="form" method="POST" action="{{ url('user/update') }}">
                     ...
                     <div class="form-group
                        ...
                        <div class="col-sm-10">
                            @if (old('firstname') == "")
                                <input type="text" class="form-control" name="firstname" placeholder="FirstName" required="" value="{{ $user['firstname']}}">
                            @endif
                    ...
                    <div class="form-group
                        ...
                        @endif">
                            ...
                            <div class="col-sm-10">
                                ...
                                @if (old('lastname')  == "")
                                    <input type="text" class="form-control" name="lastname" placeholder="LastName" required="" value="{{ $user['lastname'] }}">
                                @endif
                                @if (old('lastname') != "" )
                                    ...
                                    @if(old('role')  == "")
                                        @if(isset($user['userrole']))
                                            @foreach($user['roles'] as $role)
                                                <option value="{{$role->id}}" @if( $user['userrole'] == $role->id) selected @endif >{{$role->display_name}}</option>
                                            @endforeach
                                        @endif
                                    @endif
                                    @if(old('role')  != "")
