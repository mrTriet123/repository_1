...
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row m-b-lg m-t-lg">
    <form class="form-horizontal" role="form" method="POST" action="{{ url('driver/update_profile') }}" enctype="multipart/form-data" file="true">
      {!! csrf_field() !!}
        <div class="col-md-3">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab-1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <input class="form-control" type="text" name="firstname" value="{{$users['firstname']}}">
                    </div>
                  </div>
                    ...
                    <div class="col-lg-8">
                      <div class="ui-select">
                        <select id="user_time_zone" class="form-control" name="gender">
                          <option value="Male" @if($users['lastname'] == 'Male') selected="" @endif>Male</option>
                          <option value="Female" @if($users['lastname'] == 'Female') selected="" @endif>Female</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <input class="form-control" type="text" name="contact_no" value="{{$users['contact_no']}}">
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-md-3 control-label">Date Of Birthday:</label>
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="dob" value="{{$users['dob']}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <textarea class="form-control" rows="4" name="address" placeholder="address" required="">{{$users['address']}}</textarea>
                    </div>
                  </div>
